...
const buttonb = document.querySelector(".botao-busca"); const modalcriar = document.querySelector("#modalCriar") 
buttonb.addEventListener("click", () => { modalcriar.style.display="block"; })
